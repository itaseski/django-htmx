(function (e, t) {
  ...
  return (function () {
    ...
    var C = {
      ...
      getClosestMatch: c,
      getExpressionVars: vr,
      getHeaders: nr,
      getInputValues: Qt,
      getInternalData: ee,
      getSwapSpecification: or,
      getTriggerSpecs: Ge,
      getTarget: ve,
      makeFragment: l,
      mergeObjects: ne,
    ...
    function _(e, t) {
      if (t.indexOf("closest ") === 0) {
        ...
        return [z(e, r(t.substr(5)))];
      } else if (t.indexOf("previous ") === 0) {
        return [$(e, r(t.substr(9)))];
      } else if (t === "document") {
        return [document];
      } else if (t === "window") {
        return [window];
    ...
    function pe(t, r) {
      te(t.attributes, function (e) {
        if (!r.hasAttribute(e.name) && ge(e.name)) {
      ...
      switch (e) {
        ...
        default:
          ...
          if (e === "innerHTML") {
            ...
            Me(G.config.defaultSwapStyle, t, r, n, i);
          }
      }
    }
    function De(e) {
    ...
    function We(e) {
      ...
      var r = 0;
      while (r < e.length) {
        if (Be.exec(e.charAt(r))) {
          var n = r;
          while (Ve.exec(e.charAt(r + 1))) {
            r++;
          }
    ...
    function At(t) {
      if (t.closest && t.closest(G.config.disableSelector)) {
        return;
      }
      var r = ee(t);
      if (r.initHash !== Re(t)) {
    ...
    function Qt(e, t) {
      ...
      Kt(r, n, a, e, s);
      if (o.lastButtonClicked) {
        var l = J(o.lastButtonClicked, "name");
        if (l) {
          n[l] = o.lastButtonClicked.value;
        }
      }
      var u = he(e, "hx-include");
      te(u, function (e) {
        Kt(r, n, a, e, s);
        if (!h(e, "form")) {
    ...
    function hr(e, t) {
      return fr(e, "hx-vars", true, t);
    }
    function dr(e, t) {
      return fr(e, "hx-vals", false, t);
    }
    function vr(e) {
      return ne(hr(e), dr(e));
    }
    ...
    function se(e, t, n, r, i, M) {
      ...
      if (G.config.getCacheBusterParam && e === "get") {
        q["org.htmx.cache-buster"] = J(l, "id") || "true";
      }
      if (t == null || t === "") {
        t = K().location.href;
      }
      var T = fr(n, "hx-request");
      var V = ee(n).boosted;
      ...
      var L = {
        ...
        errors: C,
        withCredentials:
          i.credentials || T.credentials || G.config.withCredentials,
        timeout: i.timeout || T.timeout || G.config.timeout,
        path: t,
        triggeringEvent: r,
      };
      ...
      if (i.shouldSwap) {
        ...
        var o = function () {
          try {
            ...
            var n = S(c);
            Xe(h.swapStyle, c, l, v, n, r);
            if (t.elt && !re(t.elt) && t.elt.id) {
              var i = document.getElementById(t.elt.id);
              var a = {
                preventScroll:
            ...
            var s = function () {
              ...
              if (E(f, /HX-Trigger-After-Settle:/i)) {
                ...
                Fe(f, "HX-Trigger-After-Settle", r);
              }
              Q(g);
            };
            if (h.settleDelay > 0) {
